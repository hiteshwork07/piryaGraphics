...
const Splash = () => {
  return (
    <>
      <SEO title="PRIY Graphics | Printing | Advertising Services in Surat" />
              ...
              <div className="col-lg-12">
                <div className="inner text-center">
                  <div className="react-image mb--20">
                    <img
                      src="./images/demo/react-badge.png"
                      alt="PRIY Graphics | Printing | Advertising Services in Surat React"
                    />
                  </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <SectionTitle
                  ...
                  title="PRIY Graphics | Printing | Advertising Services in Surat All Demo."
            ...
            <div className="row">
              <div className="col-lg-12">
                <SectionTitle
                  ...
                  description="Have a nice inner pages include in PRIY Graphics | Printing | Advertising Services in Surat template."
                />
              </div>
            </div>
