...
const Button = () => {
  return (
    <>
      <SEO title="Button || PRIY Graphics | Printing | Advertising Services in Surat - React Business  Template" />
      <Layout>
        <BreadcrumbOne
          title=""
          rootUrl="/"
            ...
            <div className="container">
              <div className="row row--30">
                <div className="col-lg-6 col-md-6 col-12">
                  ...
                  >
                    <Link
                      className="btn-default btn-extra-large btn-icon"
                      to="#"
                    >
                      Button Solid{" "}
                      <i className="icon">
                ...
                <div className="col-lg-6 col-md-6 col-12 mt_sm--40">
                  ...
                  >
                    <Link
                      className="btn-default btn-large btn-border btn-icon"
                      to="#"
                    >
                      Button Outlined{" "}
                      <i className="icon">
                  ...
                  >
                    <Link
                      className="btn-default btn-extra-large btn-border btn-icon"
                      to="#"
                    >
                      Button Outlined{" "}
                      <i className="icon">
              ...
              <div className="row row--30">
                <div className="col-lg-12 col-md-6 col-12">
                  ...
                  >
                    ...
                    <Link className="btn-default round" to="#">
                      <span>View More</span>
                    </Link>
                    <Link className="btn-default square" to="#">
                      <span>View More</span>
                    </Link>
                    <Link className="btn-default rounded-player" to="#">
                      <span>
                        <FiPlay />
                      </span>
                    </Link>
                    <Link
                      className="btn-default rounded-player btn-border"
                      to="#"
                    >
                      <span>
                        <FiPlay />
