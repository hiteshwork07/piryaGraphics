...
const callToActionData = {
  ...
  subtitle:
    "If you want to create a corporate template you can purshace now our PRIY Graphics | Printing | Advertising Services in Surat template.",
  btnText: "Purchase PRIY Graphics | Printing | Advertising Services in Surat",
};
